...
public:
	...
	EffectType& MonEffectType() { return effect; }
	Vector2 Direction() { return direct; }

	Weapon* GetWeapon() { return weapon; }
	EffectManager*  GetMagic() { return magic; }
