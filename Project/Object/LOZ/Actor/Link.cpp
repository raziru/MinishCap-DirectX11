...
Link::Link()
{
	...
	SoundManager::GetInstance()->AddSound("LinkFall",   "_Sound/MC_Link_Fall.wav");
	SoundManager::GetInstance()->AddSound("LinkHurt",   "_Sound/MC_Link_Hurt.wav");
	SoundManager::GetInstance()->AddSound("LinkRoll",   "_Sound/MC_Link_Roll.wav");
	SoundManager::GetInstance()->AddSound("LinkSword1", "_Sound/MC_Link_Sword1.wav");
	SoundManager::GetInstance()->AddSound("LinkSword2", "_Sound/MC_Link_Sword2.wav");
	SoundManager::GetInstance()->AddSound("LinkSword3", "_Sound/MC_Link_Sword3.wav");
	SoundManager::GetInstance()->AddSound("LinkSpin",   "_Sound/MC_Link_Sword_Spin2.wav");
...
void Link::Update()
{
	...
	if(canControl)
	{
		...
		{
			SoundManager::GetInstance()->Play("LinkRoll", 0.03f);
	...
	if (KEY_DOWN(VK_SPACE)&&!weapon->IsActive())
	{
		...
		case 0 :
			index++;
			SoundManager::GetInstance()->Play("LinkSword1");
			break;
		case 1:
			SoundManager::GetInstance()->Play("LinkSword2");
			index++;
			break;
		case 2:
			index = 0;
			SoundManager::GetInstance()->Play("LinkSword3");
		...
		weapon->Attack({ 0,0 },this->translation);
		isAttack = true;
		switch (direct)
		{
		case Link::FORWARD:
...
{
	SoundManager::GetInstance()->Play("LinkSpin");
...
void Link::GetDamaged(Vector2 vector,int damage)
{
	...
	canControl = false;
	SoundManager::GetInstance()->Play("LinkHurt");
...
{
	SoundManager::GetInstance()->Play("LinkFall",0.07f);
